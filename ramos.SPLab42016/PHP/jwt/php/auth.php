...
// opcion 2
  ...
  // $DatosPorPost=$_POST['id'];
    ...
    require_once '../../clases/Persona.php';
     ...
     $verificado=Persona::TraerUnUsuario($user->usuario,$user->clave);	
      

 	if($verificado->perfil=="1") 
 	{ 
 		
		$ClaveDeEncriptacion = "estaEsLaClave";
		$token["usuario"] = $verificado->correo;
		$token["nombre"]=$verificado->nombre;
		$token["perfil"] = "1";
		$token["iat"] = time();
		$token["exp"] = time()+20;
		$jwt = JWT::encode($token, $ClaveDeEncriptacion);
